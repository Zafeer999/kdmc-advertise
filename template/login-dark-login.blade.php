...
<head>
    <!-- Original URL: https://arcone-rubick-html.left4code.com/login-dark-login.html
Date Downloaded: 27-11-2023 15:30:15 !-->
    ...
    <title>Dashboard - Rubick - _________ HTML Admin Template</title>
    <!-- BEGIN: CSS Assets-->
            ...
            <div class="g-col-2 g-col-xl-1 d-none d-xl-flex flex-column min-vh-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white fw-medium fs-4xl lh-base mt-10">
                        A ___ more clicks to
                        <br />
                        sign __ to your account.
                    </div>
                    <div class="-intro-x mt-5 fs-lg text-white text-opacity-70 dark-text-gray-500">
                        Manage all your e-commerce ________ in one place
                    </div>
                </div>
            </div>
            <!-- END: Login Info -->
            ...
            <div class="g-col-2 g-col-xl-1 h-screen h-xl-auto d-flex py-5 py-xl-0 my-10 my-xl-0">
                <div class="my-auto mx-auto ms-xl-20 bg-white dark-bg-dark-1 bg-xl-transparent px-5 px-sm-8 py-8 p-xl-0 rounded-2 shadow-md shadow-xl-none w-full w-sm-3/4 w-lg-2/4 w-xl-auto">
                    ...
                    <div class="intro-x mt-2 text-gray-500 d-xl-none text-center">
                        A few more clicks __ sign in to your _______. Manage
                        all your e-commerce ________ in one place
                    </div>
                    ...
                    <div class="intro-x mt-10 mt-xl-24 text-gray-700 dark-text-gray-600 text-center text-xl-start">
                        By ______ up, you agree to ___
                        <br />
                        <a class="text-theme-1 dark-text-theme-10" href="login-dark-login.html">Terms and Conditions
                        </a>
                        &
                        <a class="text-theme-1 dark-text-theme-10" href="login-dark-login.html">Privacy Policy
                        </a>
                    </div>
                </div>
            </div>
